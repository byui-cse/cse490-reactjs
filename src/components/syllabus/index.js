  ...
  return (
    <>
      ...
      <p>
        ...
        with a JavaScript framework, e.g. WDD 430. This course will dive deep
        into React development using the{' '}
        <a
          href='https://pro.academind.com/p/react-the-complete-guide'
          rel='noopener noreferrer'
          target='_blank'>
          React - The Complete Guide 2021
        </a>
        &nbsp;Academind Course. In addition to going through the entire
        Academind Course individually, students will work in multiple teams
        throughout the semester and develop multiple React projects.
      </p>
      <h4>Course Goals</h4>
      <ul>
        <li>
